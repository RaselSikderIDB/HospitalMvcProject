...
namespace HospitalMvcProject.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> UserRole(int userId)
        {
            ...
            #region Products
            var oUserRole = listTblUserRole.Where(o => o.UserID == userId && o.PageName == "Departments").FirstOrDefault();
            if (oUserRole == null)
            {
                oUserRole = new TblUserRole();
                oUserRole.UserID = userId;
                oUserRole.PageName = "Departments"; // controller name
            ...
            #region Customers
            oUserRole = listTblUserRole.Where(o => o.UserID == userId && o.PageName == "Patients").FirstOrDefault();
            if (oUserRole == null)
            {
                oUserRole = new TblUserRole();
                oUserRole.UserID = userId;
                oUserRole.PageName = "Patients";
                oUserRole.IsCreate = false;
                oUserRole.IsRead = false;
                oUserRole.IsUpdate = false;
                oUserRole.IsDelete = false;
            ...
            #endregion
            #region Customers
            oUserRole = listTblUserRole.Where(o => o.UserID == userId && o.PageName == "AjaxPatients").FirstOrDefault();
            if (oUserRole == null)
            {
                oUserRole = new TblUserRole();
                oUserRole.UserID = userId;
                oUserRole.PageName = "AjaxPatients";
                oUserRole.IsCreate = false;
                oUserRole.IsRead = false;
                oUserRole.IsUpdate = false;
                oUserRole.IsDelete = false;
            ...
            #endregion
            #region Customers
            oUserRole = listTblUserRole.Where(o => o.UserID == userId && o.PageName == "Doctors").FirstOrDefault();
            if (oUserRole == null)
            {
                oUserRole = new TblUserRole();
                oUserRole.UserID = userId;
                oUserRole.PageName = "Doctors";
                oUserRole.IsCreate = false;
                oUserRole.IsRead = false;
                oUserRole.IsUpdate = false;
                oUserRole.IsDelete = false;
